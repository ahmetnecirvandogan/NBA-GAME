...
public class PowerForwards {
	...
	public PowerForwards(String name, int age, long power) {
		this.name = name;
		this.age = age;
		this.power = power; 
    ...
    public static void main(String[] args) {
        String path = "playerpositionPF.txt";
        String line = "";

        try (BufferedReader br = new BufferedReader(new FileReader(path));
             BufferedWriter powers = new BufferedWriter(new FileWriter("powersOfPF.txt"))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                power = Math.round(ptsRandom * (1.0 / 10) + astRandom * (2.0 / 10) + trbRandom * (3.0 / 10) + blkRandom * (3.0 / 10) + stlRandom * (1.0 / 10));
