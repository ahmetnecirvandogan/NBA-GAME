...
public class ShootingGuards {
	...
	public ShootingGuards(String name, int age, long power) {
		this.name = name;
		this.age = age;
		this.power = power; 
    ...
    public static void main(String[] args) {
        String path = "playerpositionSG.txt";
        String line = "";

        try (BufferedReader br = new BufferedReader(new FileReader(path));
             BufferedWriter powers = new BufferedWriter(new FileWriter("powersOfSG.txt"))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                power = Math.round(ptsRandom * (4.0 / 10) + astRandom * (2.0 / 10) + trbRandom * (1.0 / 10) + blkRandom * (1.0 / 10) + stlRandom * (2.0 / 10));
