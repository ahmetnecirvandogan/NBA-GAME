...
public class Centers {
	...
	public Centers(String name, int age, long power) {
		this.name = name;
		this.age = age;
		this.power = power; 
    ...
    public static void main(String[] args) {
        String path = "playerpositionC.txt";
        String line = "";

        try (BufferedReader br = new BufferedReader(new FileReader(path));
             BufferedWriter powers = new BufferedWriter(new FileWriter("powersOfC.txt"))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                power = Math.round(ptsRandom * (0.2) + astRandom * (0.2) + trbRandom * (0.2) + blkRandom * (0.2) + stlRandom * (0.2));
