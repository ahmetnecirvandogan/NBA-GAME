...
public class PointGuards {
	...
	public PointGuards(String name, int age, long power) {
		this.name = name;
		this.age = age;
		this.power = power;
    ...
    public static void main(String[] args) {
        String path = "playerpositionPG.txt";
        String line = "";

        try (BufferedReader br = new BufferedReader(new FileReader(path));
             BufferedWriter powers = new BufferedWriter(new FileWriter("powersOfPG.txt"))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                power = Math.round(ptsRandom * (3.0 / 10) + astRandom * (4.0 / 10) + trbRandom * (0.5 / 10) + blkRandom * (0.5 / 10) + stlRandom * (2.0 / 10));
